...
const servicesList = [
  {
    serviceName: "Credit",
    serviceImage: "./images/services_images/1.png",
    seriviceDescription:
  ...
  },
  {
    ...
    serviceImage: "./images/services_images/2.png",
    seriviceDescription:
  ...
  },
  {
    ...
    serviceImage: "./images/services_images/4.png",
    seriviceDescription:
  ...
  },
  {
    ...
    serviceImage: "./images/services_images/5.png",
    seriviceDescription:
  ...
  },
  {
    ...
    serviceImage: "./images/services_images/6.png",
    seriviceDescription:
...
class Services extends Component {
  render() {
    return (
      <div className="container-fluid mt-5 pt-5 our-services-bg">
        <h1 className="text-center">Our Services</h1>
        <div className="row justify-content-center mt-3 ml-5 mr-5">
